...
contract DataChunkCompiler {
        ...
        return
            string(
                abi.encodePacked(
                    ...
                    "%253C!DOCTYPE%2520html%253E%253Chtml%2520lang%253D%2522en%2522%253E", // <!DOCTYPE html><html lang="en"> // Ara added
                    BEGIN_SCRIPT_DATA,
                    base64Utils,
                    END_SCRIPT_DATA,
                    BEGIN_SCRIPT_DATA,
    ...
    function compile4(address chunk1, address chunk2, address chunk3, address chunk4) public view returns (string memory) {
        IDataChunk data1 = IDataChunk(chunk1);
        IDataChunk data2 = IDataChunk(chunk2);
        IDataChunk data3 = IDataChunk(chunk3);
    ...
    function compile5(address chunk1, address chunk2, address chunk3, address chunk4, address chunk5) public view returns (string memory) {
        IDataChunk data1 = IDataChunk(chunk1);
        IDataChunk data2 = IDataChunk(chunk2);
        IDataChunk data3 = IDataChunk(chunk3);
        IDataChunk data4 = IDataChunk(chunk4);
    ...
    function compile6(address chunk1, address chunk2, address chunk3, address chunk4, address chunk5, address chunk6) public view returns (string memory) {
        IDataChunk data1 = IDataChunk(chunk1);
        IDataChunk data2 = IDataChunk(chunk2);
        IDataChunk data3 = IDataChunk(chunk3);
        IDataChunk data4 = IDataChunk(chunk4);
        ...
        return string(abi.encodePacked(data1.data(), data2.data(), data3.data(), data4.data(), data5.data(), data6.data()));
    }

    function compile7(address chunk1, address chunk2, address chunk3, address chunk4, address chunk5, address chunk6, address chunk7) public view returns (string memory) {
        IDataChunk data1 = IDataChunk(chunk1);
        IDataChunk data2 = IDataChunk(chunk2);
        IDataChunk data3 = IDataChunk(chunk3);
        IDataChunk data4 = IDataChunk(chunk4);
        ...
        return string(abi.encodePacked(data1.data(), data2.data(), data3.data(), data4.data(), data5.data(), data6.data(), data7.data()));
    }

    function compile8(address chunk1, address chunk2, address chunk3, address chunk4, address chunk5, address chunk6, address chunk7, address chunk8) public view returns (string memory) {
        IDataChunk data1 = IDataChunk(chunk1);
        IDataChunk data2 = IDataChunk(chunk2);
        IDataChunk data3 = IDataChunk(chunk3);
        IDataChunk data4 = IDataChunk(chunk4);
        ...
        return string(abi.encodePacked(data1.data(), data2.data(), data3.data(), data4.data(), data5.data(), data6.data(), data7.data(), data8.data()));
    }
    ...
    function compile9(
        ...
        return string(abi.encodePacked(data1.data(), data2.data(), data3.data(), data4.data(), data5.data(), data6.data(), data7.data(), data8.data(), data9.data()));
    }
}
