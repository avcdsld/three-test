...
interface IDataChunkCompiler {
    ...
    function compile4(address chunk1, address chunk2, address chunk3, address chunk4) external view returns (string memory);

    function compile5(address chunk1, address chunk2, address chunk3, address chunk4, address chunk5) external view returns (string memory);

    function compile6(address chunk1, address chunk2, address chunk3, address chunk4, address chunk5, address chunk6) external view returns (string memory);

    function compile7(address chunk1, address chunk2, address chunk3, address chunk4, address chunk5, address chunk6, address chunk7) external view returns (string memory);

    function compile8(address chunk1, address chunk2, address chunk3, address chunk4, address chunk5, address chunk6, address chunk7, address chunk8) external view returns (string memory);
...
contract TestAsciiRenderer {
    ...
    function setThreeAddress(address chunk1, address chunk2, address chunk3, address chunk4, address chunk5, address chunk6, address chunk7, address chunk8, address chunk9) public {
        require(msg.sender == owner);
        ...
        return
            string.concat(
                ...
                string.concat(
                    ...
                    // MEMO: Insert the code here. `<style>〜</style><script>〜</script>` -> percent encode -> percent encode
                    ...
                    "%253Cstyle%253E%250D%250A%2520%2520%2520%2520*%2520%257B%250D%250A%2520%2520%2520%2520%2520%2520margin%253A%25200%253B%250D%250A%2520%2520%2520%2520%2520%2520padding%253A%25200%253B%250D%250A%2520%2520%2520%2520%257D%250D%250A%2520%2520%2520%2520canvas%2520%257B%250D%250A%2520%2520%2520%2520%2520%2520width%253A%2520100%2525%253B%250D%250A%2520%2520%2520%2520%2520%2520height%253A%2520100%2525%253B%250D%250A%2520%2520%2520%2520%257D%250D%250A%2520%2520%253C%252Fstyle%253E%250D%250A%250D%250A%2520%2520%253Cscript%2520type%253D%2522importmap%2522%253E%250D%250A%2520%2520%2520%2520%257B%250D%250A%2520%2520%2520%2520%2520%2520%2522imports%2522%253A%2520%257B%250D%250A%2520%2520%2520%2520%2520%2520%2520%2520%2522three%2522%253A%2520%2522https%253A%252F%252Funpkg.com%252Fthree%25400.146.0%252Fbuild%252Fthree.module.js%2522%250D%250A%2520%2520%2520%2520%2520%2520%257D%250D%250A%2520%2520%2520%2520%257D%250D%250A%2520%2520%253C%252Fscript%253E%250D%250A%250D%250A%2520%2520%253Cscript%2520type%253D%2522module%2522%253E%250D%250A%2520%2520%2520%2520import%2520*%2520as%2520THREE%2520from%2520%2522three%2522%253B%250D%250A%250D%250A%2520%2520%2520%2520import%2520%257B%2520AsciiEffect%2520%257D%2520from%2520%2522https%253A%252F%252Funpkg.com%252Fthree%25400.146.0%252Fexamples%252Fjsm%252Feffects%252FAsciiEffect.js%2522%253B%250D%250A%2520%2520%2520%2520import%2520%257B%2520TrackballControls%2520%257D%2520from%2520%2522https%253A%252F%252Funpkg.com%252Fthree%25400.146.0%252Fexamples%252Fjsm%252Fcontrols%252FTrackballControls.js%2522%253B%250D%250A%250D%250A%2520%2520%2520%2520let%2520camera%252C%2520controls%252C%2520scene%252C%2520renderer%252C%2520effect%253B%250D%250A%250D%250A%2520%2520%2520%2520let%2520sphere%252C%2520plane%253B%250D%250A%250D%250A%2520%2520%2520%2520const%2520start%2520%253D%2520Date.now()%253B%250D%250A%250D%250A%2520%2520%2520%2520init()%253B%250D%250A%2520%2520%2520%2520animate()%253B%250D%250A%250D%250A%2520%2520%2520%2520function%2520init()%2520%257B%250D%250A%2520%2520%2520%2520%2520%2520camera%2520%253D%2520new%2520THREE.PerspectiveCamera(70%252C%2520window.innerWidth%2520%252F%2520window.innerHeight%252C%25201%252C%25201000)%253B%250D%250A%2520%2520%2520%2520%2520%2520camera.position.y%2520%253D%2520150%253B%250D%250A%2520%2520%2520%2520%2520%2520camera.position.z%2520%253D%2520500%253B%250D%250A%250D%250A%2520%2520%2520%2520%2520%2520scene%2520%253D%2520new%2520THREE.Scene()%253B%250D%250A%2520%2520%2520%2520%2520%2520scene.background%2520%253D%2520new%2520THREE.Color(0%252C%25200%252C%25200)%253B%250D%250A%250D%250A%2520%2520%2520%2520%2520%2520const%2520pointLight1%2520%253D%2520new%2520THREE.PointLight(0xffffff)%253B%250D%250A%2520%2520%2520%2520%2520%2520pointLight1.position.set(500%252C%2520500%252C%2520500)%253B%250D%250A%2520%2520%2520%2520%2520%2520scene.add(pointLight1)%253B%250D%250A%250D%250A%2520%2520%2520%2520%2520%2520const%2520pointLight2%2520%253D%2520new%2520THREE.PointLight(0xffffff%252C%25200.25)%253B%250D%250A%2520%2520%2520%2520%2520%2520pointLight2.position.set(-500%252C%2520-500%252C%2520-500)%253B%250D%250A%2520%2520%2520%2520%2520%2520scene.add(pointLight2)%253B%250D%250A%250D%250A%2520%2520%2520%2520%2520%2520sphere%2520%253D%2520new%2520THREE.Mesh(new%2520THREE.SphereGeometry(200%252C%252020%252C%252010)%252C%2520new%2520THREE.MeshPhongMaterial(%257B%2520flatShading%253A%2520true%2520%257D))%253B%250D%250A%2520%2520%2520%2520%2520%2520scene.add(sphere)%253B%250D%250A%250D%250A%2520%2520%2520%2520%2520%2520%252F%252F%2520Plane%250D%250A%250D%250A%2520%2520%2520%2520%2520%2520plane%2520%253D%2520new%2520THREE.Mesh(new%2520THREE.PlaneGeometry(400%252C%2520400)%252C%2520new%2520THREE.MeshBasicMaterial(%257B%2520color%253A%25200xe0e0e0%2520%257D))%253B%250D%250A%2520%2520%2520%2520%2520%2520plane.position.y%2520%253D%2520-200%253B%250D%250A%2520%2520%2520%2520%2520%2520plane.rotation.x%2520%253D%2520-Math.PI%2520%252F%25202%253B%250D%250A%2520%2520%2520%2520%2520%2520scene.add(plane)%253B%250D%250A%250D%250A%2520%2520%2520%2520%2520%2520renderer%2520%253D%2520new%2520THREE.WebGLRenderer()%253B%250D%250A%2520%2520%2520%2520%2520%2520renderer.setSize(window.innerWidth%252C%2520window.innerHeight)%253B%250D%250A%250D%250A%2520%2520%2520%2520%2520%2520effect%2520%253D%2520new%2520AsciiEffect(renderer%252C%2520%2522%2520.%253A-%252B*%253D%2525%2540%2523%2522%252C%2520%257B%2520invert%253A%2520true%2520%257D)%253B%250D%250A%2520%2520%2520%2520%2520%2520effect.setSize(window.innerWidth%252C%2520window.innerHeight)%253B%250D%250A%2520%2520%2520%2520%2520%2520effect.domElement.style.color%2520%253D%2520%2522white%2522%253B%250D%250A%2520%2520%2520%2520%2520%2520effect.domElement.style.backgroundColor%2520%253D%2520%2522black%2522%253B%250D%250A%250D%250A%2520%2520%2520%2520%2520%2520%252F%252F%2520Special%2520case%253A%2520append%2520effect.domElement%252C%2520instead%2520of%2520renderer.domElement.%250D%250A%2520%2520%2520%2520%2520%2520%252F%252F%2520AsciiEffect%2520creates%2520a%2520custom%2520domElement%2520(a%2520div%2520container)%2520where%2520the%2520ASCII%2520elements%2520are%2520placed.%250D%250A%250D%250A%2520%2520%2520%2520%2520%2520document.body.appendChild(effect.domElement)%253B%250D%250A%250D%250A%2520%2520%2520%2520%2520%2520controls%2520%253D%2520new%2520TrackballControls(camera%252C%2520effect.domElement)%253B%250D%250A%250D%250A%2520%2520%2520%2520%2520%2520%252F%252F%250D%250A%250D%250A%2520%2520%2520%2520%2520%2520window.addEventListener(%2522resize%2522%252C%2520onWindowResize)%253B%250D%250A%2520%2520%2520%2520%257D%250D%250A%250D%250A%2520%2520%2520%2520function%2520onWindowResize()%2520%257B%250D%250A%2520%2520%2520%2520%2520%2520camera.aspect%2520%253D%2520window.innerWidth%2520%252F%2520window.innerHeight%253B%250D%250A%2520%2520%2520%2520%2520%2520camera.updateProjectionMatrix()%253B%250D%250A%250D%250A%2520%2520%2520%2520%2520%2520renderer.setSize(window.innerWidth%252C%2520window.innerHeight)%253B%250D%250A%2520%2520%2520%2520%2520%2520effect.setSize(window.innerWidth%252C%2520window.innerHeight)%253B%250D%250A%2520%2520%2520%2520%257D%250D%250A%250D%250A%2520%2520%2520%2520%252F%252F%250D%250A%250D%250A%2520%2520%2520%2520function%2520animate()%2520%257B%250D%250A%2520%2520%2520%2520%2520%2520requestAnimationFrame(animate)%253B%250D%250A%250D%250A%2520%2520%2520%2520%2520%2520render()%253B%250D%250A%2520%2520%2520%2520%257D%250D%250A%250D%250A%2520%2520%2520%2520function%2520render()%2520%257B%250D%250A%2520%2520%2520%2520%2520%2520const%2520timer%2520%253D%2520Date.now()%2520-%2520start%253B%250D%250A%250D%250A%2520%2520%2520%2520%2520%2520sphere.position.y%2520%253D%2520Math.abs(Math.sin(timer%2520*%25200.002))%2520*%2520150%253B%250D%250A%2520%2520%2520%2520%2520%2520sphere.rotation.x%2520%253D%2520timer%2520*%25200.0003%253B%250D%250A%2520%2520%2520%2520%2520%2520sphere.rotation.z%2520%253D%2520timer%2520*%25200.0002%253B%250D%250A%250D%250A%2520%2520%2520%2520%2520%2520controls.update()%253B%250D%250A%250D%250A%2520%2520%2520%2520%2520%2520effect.render(scene%252C%2520camera)%253B%250D%250A%2520%2520%2520%2520%257D%250D%250A%2520%2520%253C%252Fscript%253E",
                    "%253C%252Fhtml%253E", // </html> // Ara added
